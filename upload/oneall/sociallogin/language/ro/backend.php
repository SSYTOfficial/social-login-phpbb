...
/**
 * Romanian translations for OneAll by SSYT
 * http://www.procms.com
 */
if (!defined ('IN_PHPBB'))
{
...
$lang = array_merge ($lang, array(
	...
	'OA_SOCIAL_LOGIN_CREATE_ACCOUNT_FIRST' => 'To be able to use Social Login, you first of all have to create a free account at <a href="https://app.oneall.com/signup/" class="external">http://www.oneall.com</a>.',
	...
	'OA_SOCIAL_LOGIN_GET_HELP' => '<a href="https://support.oneall.com/forums/" class="external">Contact us</a> if you have feedback or need assistance!',
	...
	'OA_SOCIAL_LOGIN_API_CONNECTION_HANDLER_DESC' => 'This is how your server will communicate with the OneAll social network integration service.',
	...
	'OA_SOCIAL_LOGIN_API_PORT_DESC' => 'Your firewall must allow outgoing requests on port 80 and/or 443.',
	...
	'OA_SOCIAL_LOGIN_DO_AVATARS' => 'Enable uploading avatars from social networks?',
	...
	'OA_SOCIAL_LOGIN_DO_VALIDATION_DEPENDS' => 'Profile validation only if necessary',
	...
	'OA_SOCIAL_LOGIN_INLINE_PAGE' => 'Forum Login Page (inline display)',
	'OA_SOCIAL_LOGIN_INLINE_PAGE_CAPTION' => 'Login form caption',
